...
has not uploaded this phase to production. For a remote participant, arrange
access to an explicitly authorized hosted build first.

Use a separate browser profile so this session does not replace a personal
save. Ask the participant to open NEW GUILD and run the branch until head
office reviews it. They may use the tutorial, skip it, or open HELP. Do not
explain the promotion solution or coach their clicks during observation.
...
- Whether they understand the two review targets and the return cutoff.
- Review result, day of first certification and first Bronze commission,
  and whether they can explain why the review passed or missed its targets.
