...
| 8.6 Update capture and publishing coverage. | Verified | src/headquarters/tests.rs; existing rule tests; asset_registry.json; publish.ps1 | 33 game/asset/source tests; 2 chroma tests; no-argument Preview publishing |
