...
impl Lesson {
    ...
    pub fn text(self, compact: bool) -> &'static str {
        match self {
            Self::Welcome => "By day 30, certify one Bronze adventurer and complete A Bridge Worth Keeping. Each adventurer earns their own rank and XP. Day 30 returns count before head office reviews the branch.\n\nTap BACK TO DESK, then the D30 objective control to see your targets. MENU opens HELP whenever you need it.",
