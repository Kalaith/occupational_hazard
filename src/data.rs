...
pub const REQUIRED_TEXT_KEYS: &[&str] = &[
    ...
    "ui.readiness_details",
    "ui.hide_readiness_details",
    "ui.decision_service",
    "ui.dispatch_service",
    "ui.service_new",
    "ui.service_credited",
    ...
    "error.unsupported_legacy_records",
    "error.invalid_saved_contracts",
    "error.unknown_saved_contract",
    "error.invalid_saved_expedition",
    "error.invalid_saved_scout",
    "error.contract_migration_required",
    "error.invalid_service_quota_records",
    "error.invalid_dated_expedition_records",
    "error.invalid_scouting_records",
    "error.invalid_guild_records",
    "error.invalid_expedition_records",
    "error.duplicate_adventurer_assignment",
    "error.invalid_adventurer_records",
    "error.sandbox_missing_review",
    "error.invalid_first_month_review",
