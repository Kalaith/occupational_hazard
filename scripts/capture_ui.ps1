...
#>
param(
    [ValidateSet("title", "gameplay", "settings", "promotion", "report", "reports", "victory", "tomas", "pip", "services", "objectives", "review", "review_missed", "tutorial")]
    [string[]]$Scenes = @("title", "gameplay", "settings", "promotion", "report", "reports", "victory", "tomas", "pip", "services", "objectives", "review", "review_missed", "tutorial"),
    [int]$Frames = 150,
